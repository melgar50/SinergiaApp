	...
	<body>
				  	...
				  	<div class="card">
							...
							<div class="card-body">
								<ul class="list-unstyled mb-0">
									...
									<li>
										<a class="d-flex align-items-center link-dark" href="#!">
											<span class="h3 mb-0"><i class="far fa-share-square text-muted mr-3"></i><a href='/SinergiaApp/usuario/cerrarsesion.php'></span> Cerrar Sesion
										</a>
									</li>
								</ul>
							</div>
		...
		<main class="u-main" role="main">
						...
						<ul class="u-sidebar-nav-menu u-sidebar-nav-menu--top-level">
							...
							<li class="u-sidebar-nav-menu__item">
								...
								<ul id="baseUI" class="u-sidebar-nav-menu u-sidebar-nav-menu--second-level" style="display: none;">
									<li class="u-sidebar-nav-menu__item">
										<a class="u-sidebar-nav-menu__link" href="./crearalumno.html">
           ...
           <!-- End Sidebar -->
					...
					<div class="mb-4">
						<nav aria-label="breadcrumb">
						  ...
						  <ol class="breadcrumb bg-transparent small p-0">
						    <li class="breadcrumb-item"><a href="./crearalumno.html">Agregar Alumno</a></li>
			...
			<body>
		    <header>
						<h2 class= "text-center text=dark"><span class="badge-warning"> CRUD ALUMNO </span></h2>
